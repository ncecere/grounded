...
`)?"":`
`)+n.raw,s.text+=`
`+n.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=s.text):r.push(n);continue}if(e){let s="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(s);break}else throw new Error(s)}}return this.state.top=!0,r}inline(e,r=[]){return this.inlineQueue.push({src:e,tokens:r}),r}inlineTokens(e,r=[]){let o=e,n=null;if(this.tokens.links){let i=Object.keys(this.tokens.links);if(i.length>0)for(;(n=this.tokenizer.rules.inline.reflinkSearch.exec(o))!=null;)i.includes(n[0].slice(n[0].lastIndexOf("[")+1,-1))&&(o=o.slice(0,n.index)+"["+"a".repeat(n[0].length-2)+"]"+o.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(n=this.tokenizer.rules.inline.anyPunctuation.exec(o))!=null;)o=o.slice(0,n.index)+"++"+o.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let a;for(;(n=this.tokenizer.rules.inline.blockSkip.exec(o))!=null;)a=n[2]?n[2].length:0,o=o.slice(0,n.index+a)+"["+"a".repeat(n[0].length-a-2)+"]"+o.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);o=this.options.hooks?.emStrongMask?.call({lexer:this},o)??o;let s=!1,l="";for(;e;){s||(l=""),s=!1;let i;if(this.options.extensions?.inline?.some(c=>(i=c.call({lexer:this},e,r))?(e=e.substring(i.raw.length),r.push(i),!0):!1))continue;if(i=this.tokenizer.escape(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.tag(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.link(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(i.raw.length);let c=r.at(-1);i.type==="text"&&c?.type==="text"?(c.raw+=i.raw,c.text+=i.text):r.push(i);continue}if(i=this.tokenizer.emStrong(e,o,l)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.codespan(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.br(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.del(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.autolink(e)){e=e.substring(i.raw.length),r.push(i);continue}if(!this.state.inLink&&(i=this.tokenizer.url(e))){e=e.substring(i.raw.length),r.push(i);continue}let u=e;if(this.options.extensions?.startInline){let c=1/0,d=e.slice(1),p;this.options.extensions.startInline.forEach(h=>{p=h.call({lexer:this},d),typeof p=="number"&&p>=0&&(c=Math.min(c,p))}),c<1/0&&c>=0&&(u=e.substring(0,c+1))}if(i=this.tokenizer.inlineText(u)){e=e.substring(i.raw.length),i.raw.slice(-1)!=="_"&&(l=i.raw.slice(-1)),s=!0;let c=r.at(-1);c?.type==="text"?(c.raw+=i.raw,c.text+=i.text):r.push(i);continue}if(e){let c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return r}},we=class{options;parser;constructor(t){this.options=t||U}space(t){return""}code({text:t,lang:e,escaped:r}){let o=(e||"").match(C.notSpaceStart)?.[0],n=t.replace(C.endingNewline,"")+`
...
`}strong({tokens:t}){return`<strong>${this.parser.parseInline(t)}</strong>`}em({tokens:t}){return`<em>${this.parser.parseInline(t)}</em>`}codespan({text:t}){return`<code>${D(t,!0)}</code>`}br(t){return"<br>"}del({tokens:t}){return`<del>${this.parser.parseInline(t)}</del>`}link({href:t,title:e,tokens:r}){let o=this.parser.parseInline(r),n=Ht(t);if(n===null)return o;t=n;let a='<a href="'+t+'"';return e&&(a+=' title="'+D(e)+'"'),a+=">"+o+"</a>",a}image({href:t,title:e,text:r,tokens:o}){o&&(r=this.parser.parseInline(o,this.parser.textRenderer));let n=Ht(t);if(n===null)return D(r);t=n;let a=`<img src="${t}" alt="${r}"`;return e&&(a+=` title="${D(e)}"`),a+=">",a}text(t){return"tokens"in t&&t.tokens?this.parser.parseInline(t.tokens):"escaped"in t&&t.escaped?t.text:D(t.text)}},Ze=class{strong({text:t}){return t}em({text:t}){return t}codespan({text:t}){return t}del({text:t}){return t}html({text:t}){return t}text({text:t}){return t}link({text:t}){return""+t}image({text:t}){return""+t}br(){return""}checkbox({raw:t}){return t}},j=class Ye{options;renderer;textRenderer;constructor(e){this.options=e||U,this.options.renderer=this.options.renderer||new we,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new Ze}static parse(e,r){return new Ye(r).parse(e)}static parseInline(e,r){return new Ye(r).parseInline(e)}parse(e){let r="";for(let o=0;o<e.length;o++){let n=e[o];if(this.options.extensions?.renderers?.[n.type]){let s=n,l=this.options.extensions.renderers[s.type].call({parser:this},s);if(l!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(s.type)){r+=l||"";continue}}let a=n;switch(a.type){case"space":{r+=this.renderer.space(a);break}case"hr":{r+=this.renderer.hr(a);break}case"heading":{r+=this.renderer.heading(a);break}case"code":{r+=this.renderer.code(a);break}case"table":{r+=this.renderer.table(a);break}case"blockquote":{r+=this.renderer.blockquote(a);break}case"list":{r+=this.renderer.list(a);break}case"checkbox":{r+=this.renderer.checkbox(a);break}case"html":{r+=this.renderer.html(a);break}case"def":{r+=this.renderer.def(a);break}case"paragraph":{r+=this.renderer.paragraph(a);break}case"text":{r+=this.renderer.text(a);break}default:{let s='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(s),"";throw new Error(s)}}}return r}parseInline(e,r=this.renderer){let o="";for(let n=0;n<e.length;n++){let a=e[n];if(this.options.extensions?.renderers?.[a.type]){let l=this.options.extensions.renderers[a.type].call({parser:this},a);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(a.type)){o+=l||"";continue}}let s=a;switch(s.type){case"escape":{o+=r.text(s);break}case"html":{o+=r.html(s);break}case"link":{o+=r.link(s);break}case"image":{o+=r.image(s);break}case"checkbox":{o+=r.checkbox(s);break}case"strong":{o+=r.strong(s);break}case"em":{o+=r.em(s);break}case"codespan":{o+=r.codespan(s);break}case"br":{o+=r.br(s);break}case"del":{o+=r.del(s);break}case"text":{o+=r.text(s);break}default:{let l='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return o}},le=class{options;block;constructor(t){this.options=t||U}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(t){return t}postprocess(t){return t}processAllTokens(t){return t}emStrongMask(t){return t}provideLexer(){return this.block?q.lex:q.lexInline}provideParser(){return this.block?j.parse:j.parseInline}},Wr=class{defaults=Fe();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=j;Renderer=we;TextRenderer=Ze;Lexer=q;Tokenizer=ye;Hooks=le;constructor(...t){this.use(...t)}walkTokens(t,e){let r=[];for(let o of t)switch(r=r.concat(e.call(this,o)),o.type){case"table":{let n=o;for(let a of n.header)r=r.concat(this.walkTokens(a.tokens,e));for(let a of n.rows)for(let s of a)r=r.concat(this.walkTokens(s.tokens,e));break}case"list":{let n=o;r=r.concat(this.walkTokens(n.items,e));break}default:{let n=o;this.defaults.extensions?.childTokens?.[n.type]?this.defaults.extensions.childTokens[n.type].forEach(a=>{let s=n[a].flat(1/0);r=r.concat(this.walkTokens(s,e))}):n.tokens&&(r=r.concat(this.walkTokens(n.tokens,e)))}}return r}use(...t){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return t.forEach(r=>{let o={...r};if(o.async=this.defaults.async||o.async||!1,r.extensions&&(r.extensions.forEach(n=>{if(!n.name)throw new Error("extension name required");if("renderer"in n){let a=e.renderers[n.name];a?e.renderers[n.name]=function(...s){let l=n.renderer.apply(this,s);return l===!1&&(l=a.apply(this,s)),l}:e.renderers[n.name]=n.renderer}if("tokenizer"in n){if(!n.level||n.level!=="block"&&n.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let a=e[n.level];a?a.unshift(n.tokenizer):e[n.level]=[n.tokenizer],n.start&&(n.level==="block"?e.startBlock?e.startBlock.push(n.start):e.startBlock=[n.start]:n.level==="inline"&&(e.startInline?e.startInline.push(n.start):e.startInline=[n.start]))}"childTokens"in n&&n.childTokens&&(e.childTokens[n.name]=n.childTokens)}),o.extensions=e),r.renderer){let n=this.defaults.renderer||new we(this.defaults);for(let a in r.renderer){if(!(a in n))throw new Error(`renderer '${a}' does not exist`);if(["options","parser"].includes(a))continue;let s=a,l=r.renderer[s],i=n[s];n[s]=(...u)=>{let c=l.apply(n,u);return c===!1&&(c=i.apply(n,u)),c||""}}o.renderer=n}if(r.tokenizer){let n=this.defaults.tokenizer||new ye(this.defaults);for(let a in r.tokenizer){if(!(a in n))throw new Error(`tokenizer '${a}' does not exist`);if(["options","rules","lexer"].includes(a))continue;let s=a,l=r.tokenizer[s],i=n[s];n[s]=(...u)=>{let c=l.apply(n,u);return c===!1&&(c=i.apply(n,u)),c}}o.tokenizer=n}if(r.hooks){let n=this.defaults.hooks||new le;for(let a in r.hooks){if(!(a in n))throw new Error(`hook '${a}' does not exist`);if(["options","block"].includes(a))continue;let s=a,l=r.hooks[s],i=n[s];le.passThroughHooks.has(a)?n[s]=u=>{if(this.defaults.async&&le.passThroughHooksRespectAsync.has(a))return(async()=>{let d=await l.call(n,u);return i.call(n,d)})();let c=l.call(n,u);return i.call(n,c)}:n[s]=(...u)=>{if(this.defaults.async)return(async()=>{let d=await l.apply(n,u);return d===!1&&(d=await i.apply(n,u)),d})();let c=l.apply(n,u);return c===!1&&(c=i.apply(n,u)),c}}o.hooks=n}if(r.walkTokens){let n=this.defaults.walkTokens,a=r.walkTokens;o.walkTokens=function(s){let l=[];return l.push(a.call(this,s)),n&&(l=l.concat(n.call(this,s))),l}}this.defaults={...this.defaults,...o}}),this}setOptions(t){return this.defaults={...this.defaults,...t},this}lexer(t,e){return q.lex(t,e??this.defaults)}parser(t,e){return j.parse(t,e??this.defaults)}parseMarkdown(t){return(e,r)=>{let o={...r},n={...this.defaults,...o},a=this.onError(!!n.silent,!!n.async);if(this.defaults.async===!0&&o.async===!1)return a(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return a(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return a(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(n.hooks&&(n.hooks.options=n,n.hooks.block=t),n.async)return(async()=>{let s=n.hooks?await n.hooks.preprocess(e):e,l=await(n.hooks?await n.hooks.provideLexer():t?q.lex:q.lexInline)(s,n),i=n.hooks?await n.hooks.processAllTokens(l):l;n.walkTokens&&await Promise.all(this.walkTokens(i,n.walkTokens));let u=await(n.hooks?await n.hooks.provideParser():t?j.parse:j.parseInline)(i,n);return n.hooks?await n.hooks.postprocess(u):u})().catch(a);try{n.hooks&&(e=n.hooks.preprocess(e));let s=(n.hooks?n.hooks.provideLexer():t?q.lex:q.lexInline)(e,n);n.hooks&&(s=n.hooks.processAllTokens(s)),n.walkTokens&&this.walkTokens(s,n.walkTokens);let l=(n.hooks?n.hooks.provideParser():t?j.parse:j.parseInline)(s,n);return n.hooks&&(l=n.hooks.postprocess(l)),l}catch(s){return a(s)}}}onError(t,e){return r=>{if(r.message+=`
Please report this to https://github.com/markedjs/marked.`,t){let o="<p>An error occurred:</p><pre>"+D(r.message+"",!0)+"</pre>";return e?Promise.resolve(o):o}if(e)return Promise.reject(r);throw r}}},Z=new Wr;function k(t,e){return Z.parse(t,e)}k.options=k.setOptions=function(t){return Z.setOptions(t),k.defaults=Z.defaults,$t(k.defaults),k},k.getDefaults=Fe,k.defaults=U,k.use=function(...t){return Z.use(...t),k.defaults=Z.defaults,$t(k.defaults),k},k.walkTokens=function(t,e){return Z.walkTokens(t,e)},k.parseInline=Z.parseInline,k.Parser=j,k.parser=j.parse,k.Renderer=we,k.TextRenderer=Ze,k.Lexer=q,k.lexer=q.lex,k.Tokenizer=ye,k.Hooks=le,k.parse=k,k.options,k.setOptions,k.use,k.walkTokens,k.parseInline,j.parse,q.lex;function Dr({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:g("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}function Wt({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),g("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]})}function Qr({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("path",{d:"m5 12 7-7 7 7"}),g("path",{d:"M12 19V5"})]})}function Or({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:g("path",{d:"m6 9 6 6 6-6"})})}function Dt({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:g("path",{d:"M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"})})}function Qt({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("path",{d:"m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"}),g("path",{d:"M5 3v4"}),g("path",{d:"M19 17v4"}),g("path",{d:"M3 5h4"}),g("path",{d:"M17 19h4"})]})}function Ur({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("polyline",{points:"15 3 21 3 21 9"}),g("polyline",{points:"9 21 3 21 3 15"}),g("line",{x1:"21",y1:"3",x2:"14",y2:"10"}),g("line",{x1:"3",y1:"21",x2:"10",y2:"14"})]})}function Zr({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("polyline",{points:"4 14 10 14 10 20"}),g("polyline",{points:"20 10 14 10 14 4"}),g("line",{x1:"14",y1:"10",x2:"21",y2:"3"}),g("line",{x1:"3",y1:"21",x2:"10",y2:"14"})]})}function Gr({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("circle",{cx:"12",cy:"12",r:"10"}),g("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"}),g("path",{d:"M12 17h.01"})]})}function Vr({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("path",{d:"M8.5 8.5a3.5 3.5 0 1 1 5 3.15c-.65.4-1.5 1.15-1.5 2.35v1"}),g("circle",{cx:"12",cy:"19",r:"0.5",fill:"currentColor"})]})}function Yr({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:g("path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z"})})}function Xr({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("path",{d:"M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"}),g("polyline",{points:"14 2 14 8 20 8"})]})}function Kr({className:t}){return g("svg",{className:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[g("circle",{cx:"11",cy:"11",r:"8"}),g("path",{d:"m21 21-4.3-4.3"})]})}k.setOptions({breaks:!0,gfm:!0});const Ot=new k.Renderer;Ot.link=({href:t,title:e,text:r})=>{const o=e?` title="${e}"`:"";return`<a href="${t}" target="_blank" rel="noopener noreferrer"${o}>${r}</a>`},k.use({renderer:Ot});function Jr(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function en(t){if(!t)return"";let e=t;return e=e.replace(/【[^】]*】/g,""),e=e.replace(/Citation:\s*[^\n.]+[.\n]/gi,""),e=e.replace(/\[Source:[^\]]*\]/gi,""),e=e.replace(/\(Source:[^)]*\)/gi,""),e=e.replace(/\[\d+\]/g,""),k.parse(e,{async:!1})}function tn({message:t}){const[e,r]=N(!1),o=t.role==="user",n=t.citations&&t.citations.length>0;return g("div",{className:`grounded-message ${t.role}`,children:[g("div",{className:"grounded-message-bubble",dangerouslySetInnerHTML:{__html:o?Jr(t.content):en(t.content)}}),t.isStreaming&&g("span",{className:"grounded-cursor"}),!o&&n&&g("div",{className:"grounded-sources",children:[g("button",{className:`grounded-sources-trigger ${e?"open":""}`,onClick:()=>r(!e),children:[g(Dt,{}),t.citations.length," source",t.citations.length!==1?"s":"",g(Or,{})]}),g("div",{className:`grounded-sources-list ${e?"open":""}`,children:t.citations.map((a,s)=>{const l=a.url?.startsWith("upload://"),i=a.title||(l?"Uploaded Document":a.url)||`Source ${s+1}`;return l?g("div",{className:"grounded-source grounded-source-file",children:[g(Xr,{}),g("span",{className:"grounded-source-title",children:i})]},s):g("a",{href:a.url||"#",target:"_blank",rel:"noopener noreferrer",className:"grounded-source",children:[g(Dt,{}),g("span",{className:"grounded-source-title",children:i})]},s)})})]})]})}function rn({status:t}){const e=()=>{if(t.message)return t.message;switch(t.status){case"searching":return"Searching knowledge base...";case"generating":return t.sourcesCount?`Found ${t.sourcesCount} relevant sources. Generating...`:"Generating response...";default:return"Thinking..."}};return g("div",{className:"grounded-status",children:g("div",{className:"grounded-status-content",children:[(()=>{switch(t.status){case"searching":return g(Kr,{className:"grounded-status-icon"});case"generating":return g(Qt,{className:"grounded-status-icon"});default:return null}})(),g("span",{className:"grounded-status-text",children:e()}),g("div",{className:"grounded-status-dots",children:[g("div",{className:"grounded-typing-dot"}),g("div",{className:"grounded-typing-dot"}),g("div",{className:"grounded-typing-dot"})]})]})})}function Ut({options:t,initialOpen:e=!1,onOpenChange:r}){const{token:o,apiBase:n="",position:a="bottom-right"}=t,[s,l]=N(e),[i,u]=N(!1),[c,d]=N(""),p=K(null),h=K(null),{config:f,isLoading:x}=ar({token:o,apiBase:n}),{messages:y,isLoading:m,chatStatus:b,sendMessage:A}=or({token:o,apiBase:n});ne(()=>{p.current&&p.current.scrollIntoView({behavior:"smooth"})},[y,m]),ne(()=>{s&&h.current&&setTimeout(()=>h.current?.focus(),100)},[s]);const z=K(!1);ne(()=>{z.current&&!m&&s&&setTimeout(()=>h.current?.focus(),50),z.current=m},[m,s]),ne(()=>{r?.(s)},[s,r]);const R=()=>{l(!s)},T=()=>{c.trim()&&!m&&(A(c),d(""),h.current&&(h.current.style.height="auto"),setTimeout(()=>{h.current?.focus()},50))},E=P=>{P.key==="Enter"&&!P.shiftKey&&(P.preventDefault(),T())},M=P=>{const ze=P.target;d(ze.value),ze.style.height="auto",ze.style.height=Math.min(ze.scrollHeight,120)+"px"},B=a==="bottom-left",I=f?.agentName||"Assistant",L=f?.welcomeMessage||"How can I help?",F=f?.description||"Ask me anything. I'm here to assist you.",G=f?.logoUrl,V=y.length===0&&!m,Se=f?.theme?.buttonStyle||"circle",$e=f?.theme?.buttonSize||"medium",de=f?.theme?.buttonText||"Chat with us",$=f?.theme?.buttonIcon||"chat",H=f?.theme?.buttonColor||"#2563eb",Q=f?.theme?.customIconUrl,J=f?.theme?.customIconSize,an=()=>{if(Q){const P=J?{"--custom-icon-size":`${J}px`}:void 0;return g("img",{src:Q,alt:"",className:"grounded-launcher-custom-icon",style:P})}switch($){case"help":return g(Gr,{});case"question":return g(Vr,{});case"message":return g(Yr,{});default:return g(Dr,{})}};return g("div",{className:`grounded-container ${B?"left":""}`,children:[g("div",{className:`grounded-window ${s?"open":""} ${i?"expanded":""}`,children:[g("div",{className:"grounded-header",children:[g("div",{className:"grounded-header-left",children:[G&&g("img",{src:G,alt:"",className:"grounded-header-logo"}),g("h2",{className:"grounded-header-title",children:I})]}),g("div",{className:"grounded-header-actions",children:[g("button",{className:"grounded-header-btn",onClick:()=>u(!i),"aria-label":i?"Shrink chat":"Expand chat",children:i?g(Zr,{}):g(Ur,{})}),g("button",{className:"grounded-header-btn",onClick:R,"aria-label":"Close chat",children:g(Wt,{})})]})]}),g("div",{className:"grounded-messages",children:[V?g("div",{className:"grounded-empty",children:[g(Qt,{className:"grounded-empty-icon"}),g("h3",{className:"grounded-empty-title",children:F}),g("p",{className:"grounded-empty-text",children:L})]}):g(Y,{children:[y.filter(P=>P.content||P.role==="user").map(P=>g(tn,{message:P},P.id)),(m||b.status!=="idle")&&b.status!=="streaming"&&g(rn,{status:b})]}),g("div",{ref:p})]}),g("div",{className:"grounded-input-area",children:g("div",{className:"grounded-input-container",children:[g("textarea",{ref:h,className:"grounded-input",placeholder:x?"Loading...":"Type a message...",value:c,onInput:M,onKeyDown:E,rows:1,disabled:m||x}),g("button",{className:"grounded-send",onClick:T,disabled:!c.trim()||m||x,"aria-label":"Send message",children:g(Qr,{})})]})}),g("div",{className:"grounded-footer",children:["Powered by ",g("a",{href:"https://grounded.ai",target:"_blank",rel:"noopener",children:"Grounded"})]})]}),g("button",{className:`grounded-launcher grounded-launcher--${Se} grounded-launcher--${$e} ${s?"open":""}`,onClick:R,"aria-label":s?"Close chat":"Open chat",style:{backgroundColor:H},children:s?g(Wt,{}):g(Y,{children:[an(),Se==="pill"&&g("span",{className:"grounded-launcher-text",children:de})]})})]})}const nn=`
